        ...
        <section className="py-24 mesh-gradient relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="glass-card rounded-3xl p-8">
                <h2 className="text-2xl font-bold font-display mb-4">3. Data Security</h2>
              ...
              <div className="glass-card rounded-3xl p-8">
                ...
                <p className="text-muted-foreground">
                  ...
                  <a href="mailto:privacy@3dassethub.com" className="text-cyan-400 hover:underline">
                    privacy@3dassethub.com
                  </a>
                </p>
              </div>
            </div>
