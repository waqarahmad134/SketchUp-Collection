...
class NewAdminProductController extends Controller
{
    public function index()
    {
        $products = Product::with(['category', 'tags'])->latest()->get();
        return view('new admin.admin.products.index', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('new admin.admin.products.create', compact('categories', 'tags', 'allProducts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('newadmin.products.index')->with('success', 'Product created successfully');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('new admin.admin.products.edit', compact('product', 'categories', 'tags', 'allProducts'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('newadmin.products.index')->with('success', 'Product updated successfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('newadmin.products.index')->with('success', 'Product deleted successfully');
    }
}
