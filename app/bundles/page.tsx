...
export const metadata: Metadata = {
  title: "Products & Bundles - 3DAssetHub | Premium SketchUp Collections",
  description: "Browse our premium 3D assets. Bundles combine 3-4 products for maximum value, or choose individual products. Professional SketchUp models at unbeatable prices.",
};
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Browse our collection of premium 3D assets. <strong>Bundles</strong> are combinations of 3-4 products 
                offered at a discounted price, while <strong>single products</strong> are individual asset packs. 
                Both work the same way - choose what fits your needs!
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              {products.map((product, index) => (
                <div
                  key={product.id}
                  className="glass-card rounded-3xl overflow-hidden hover-lift group animate-slide-in-up"
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      {product.isBundle && (
                        <span className="bg-violet-500/20 text-violet-400 text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <h3 className="text-xl font-bold font-display mb-1">{product.title}</h3>
