...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            // Robots
            $table->string('robots_index')->default('index')->after('canonical_url'); // index, noindex
            $table->string('robots_follow')->default('follow')->after('robots_index'); // follow, nofollow
            
            // Open Graph
            $table->string('og_title')->nullable()->after('robots_follow');
            $table->text('og_description')->nullable()->after('og_title');
            $table->string('og_image')->nullable()->after('og_description');
            $table->string('og_type')->default('product')->after('og_image');
