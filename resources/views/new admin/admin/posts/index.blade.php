    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-muted-foreground">
                Gestiona todos tus posts de blog
            </p>
        </div>
            ...
            <div class="space-y-4">
                ...
                >
                    ...
                    <div class="flex items-center gap-2 ml-4">
                        ...
                        <form method="POST" action="{{ route('admin.posts.destroy', $post->id) }}" onsubmit="return confirm('¿Estás seguro? Esta acción no se puede deshacer.');" class="inline">
                            @csrf
                            @method('DELETE')
                            <button
                                type="submit"
