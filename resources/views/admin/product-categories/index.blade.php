                        ...
                        <tr class="border-b hover:bg-muted/50">
                            ...
                            <td class="p-3">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.product-categories.destroy', $category->id) }}" onsubmit="return confirm('Are you sure? This action cannot be undone.');" class="inline">
                                        @csrf
                                        @method('DELETE')
