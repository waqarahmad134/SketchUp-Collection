...
<div class="p-6 md:p-8" x-data="tagManager(@js($tags), '{{ $type }}')">
    ...
    <div class="mb-6 flex gap-2">
        <a href="{{ route('admin.tags.index', ['type' => 'all']) }}" 
        ...
        <a href="{{ route('admin.tags.index', ['type' => 'product']) }}" 
        ...
        <a href="{{ route('admin.tags.index', ['type' => 'post']) }}" 
                        ...
                        <tr class="border-b hover:bg-muted/50">
                            ...
                            <td class="p-3">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.tags.destroy', $tag->id) }}" onsubmit="return confirm('Are you sure you want to delete this tag?');" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="submit"
